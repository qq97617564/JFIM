...
#define HasAFNetworking (__has_include(<AFNetworking/AFNetworking-umbrella.h>) || __has_include(<AFNetworking-umbrella.h>))
...
#define HasSDWebImage NO //(__has_include(<SDWebImage/UIImageView+WebCache.h>) || __has_include("UIImageView+WebCache.h"))
