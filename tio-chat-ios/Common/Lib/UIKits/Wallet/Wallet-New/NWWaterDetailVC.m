...
@interface NWWaterDetailVC ()

@end

@implementation NWWaterDetailVC
...
- (void)viewDidLoad {
    ...
    amountLabel.text = [NSString stringWithFormat:@"%@%.2f",symbol,self.model.cny/100.f];
    ...
    NSString *ordernumber = self.model.reqid;
    NSString *desc = self.model.remark;
