...
//    })];
    ...
    [protocolLabel addCustomLink:@(2) forRange:NSMakeRange(5, 8) linkColor:[UIColor colorWithHex:0x999999]];
    [protocolLabel addCustomLink:@(3) forRange:NSMakeRange(14, 6) linkColor:[UIColor colorWithHex:0x999999]];
