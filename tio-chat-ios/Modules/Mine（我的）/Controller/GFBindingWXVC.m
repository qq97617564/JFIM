...
@interface GFBindingWXVC ()<UIImagePickerControllerDelegate, UINavigationControllerDelegate>
{
    NSString *imageUrl;
}
...
- (IBAction)submitAction:(id)sender {
    if (self.chooseBtn.isSelected) {
        ...
        [TIOChat.shareSDK.gfHttpManager accountBindingWithType:@"wechat" cardno:self.wxTF.text username:self.nameTF.text image:imageUrl completion:^(NSDictionary * _Nullable responseObject, NSError * _Nullable error) {
