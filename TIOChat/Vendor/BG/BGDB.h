...
/// TIO: 新增
@property (nonatomic, copy) void(^ _Nullable createdDBBlock)(NSString * _Nullable tablename);
...
#pragma mark - TIO新增API

- (NSArray *_Nullable)getAllColumsInTable:(NSString *_Nullable)tableName ignoredkeys:(NSArray *_Nullable)ignoredkeys cls:(Class _Nullable )cls;
